    ...
    return (
        <Html>
            <Head>
                ...
                <meta name='twitter:image' content='https://sr-smith.syta.co/static/icons/android-chrome-192x192.png' />
                ...
                <meta property='og:image' content='https://sr-smith.syta.co/static/icons/apple-touch-icon.png' />
