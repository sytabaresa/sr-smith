...
export function ArcIcon2(props) {
    return <svg width="512" height="512" viewBox="0 0 512 512" {...props}>
        ...
        <circle cx="134.72" cy="327.4" r="35" className="fill-primary" />
        ...
        <circle cx="244.3" cy="92.81" r="35" className="fill-primary" />
        ...
        <circle cx="378.28" cy="416.19" r="35" className="fill-primary" />
...
export function AngleIcon(props) {
    return <svg width="512" height="512" viewBox="0 0 512 512" {...props}>
        ...
        <path fill="none" className="stroke-info" stroke-miterlimit="10" strokeWidth="13" d="M108.415 335.512l159.514 44.517s35.179-88.113-48.125-163.821L108.415 335.512z" />
        ...
        <circle cx="403.58" cy="417.88" r="35" className="fill-primary" />
...
export function CircleCenterPointIcon(props) {
    return <svg width="512" height="512" viewBox="0 0 512 512" {...props}>
        ...
        <circle cx="406.33" cy="149.45" r="35" className="fill-primary" />
        <path d="M428.446 133.961c8.537 12.193 5.563 29.064-6.631 37.604-12.195 8.539-29.066 5.564-37.605-6.631s-5.564-29.064 6.631-37.604 29.064-5.564 37.605 6.631m10.649-7.457c-12.672-18.096-37.615-22.492-55.709-9.822-18.096 12.67-22.496 37.613-9.824 55.709 12.672 18.098 37.613 22.494 55.709 9.824 18.095-12.672 22.496-37.613 9.824-55.711z" />
        <circle cx="256" cy="256" r="35" className="fill-primary" />
...
export function CircumcircleIcon(props) {
    return <svg width="512" height="512" viewBox="0 0 512 512" {...props}>
        ...
        <circle cx="406.33" cy="149.45" r="35" className="fill-primary" />
        <path d="M428.446 133.961c8.537 12.193 5.563 29.064-6.631 37.604-12.195 8.539-29.066 5.564-37.605-6.631s-5.564-29.064 6.631-37.604 29.064-5.564 37.605 6.631m10.649-7.457c-12.672-18.096-37.615-22.492-55.709-9.822-18.096 12.67-22.496 37.613-9.824 55.709 12.672 18.098 37.613 22.494 55.709 9.824 18.095-12.672 22.496-37.613 9.824-55.711z" />
        <circle cx="74.33" cy="224.45" r="35" className="fill-primary" />
        ...
        <circle cx="311" cy="431.45" r="35" className="fill-primary" />
...
export function LineIcon(props) {
    return <svg width="512" height="512" viewBox="0 0 512 512" {...props}>
        ...
        <circle cx="362" cy="181.96" r="35" className="fill-primary" />
        ...
        <circle cx="150" cy="330.3" r="35" className="fill-primary" />
...
export function PointIcon(props) {
    return <svg width="512" height="512" viewBox="0 0 512 512" {...props}>
        <circle cx="168.7" cy="351.73" r="53.38" className="fill-primary" />
        ...
        <path className="fill-current" d="M428.199 252.873h-24.755l-18.17-45.547h-82.212l-18.397 45.547h-24.073l70.63-170h25.437l71.54 170zm-52.69-65.56l-32.021-78.445-31.34 78.444h63.362z" />
    </svg>
}
...
export function SegmentIcon(props) {
    return <svg width="512" height="512" viewBox="0 0 512 512" {...props}>
        ...
        <circle cx="392" cy="160.96" r="35" className="fill-primary" />
        ...
        <circle cx="120" cy="350.3" r="35" className="fill-primary" />
...
export function SemicircleIcon(props) {
    return <svg width="512" height="512" viewBox="0 0 512 512" {...props}>
        ...
        <circle cx="406.33" cy="149.45" r="35" className="fill-primary" />
        <path d="M428.446 133.961c8.537 12.193 5.563 29.064-6.631 37.604-12.195 8.539-29.066 5.564-37.605-6.631s-5.564-29.064 6.631-37.604 29.064-5.564 37.605 6.631m10.649-7.457c-12.672-18.096-37.615-22.492-55.709-9.822-18.096 12.67-22.496 37.613-9.824 55.709 12.672 18.098 37.613 22.494 55.709 9.824 18.095-12.672 22.496-37.613 9.824-55.711z" />
        <circle cx="105.33" cy="361.55" r="35" className="fill-primary" />
...
export function CircumcircleArcIcon(props) {
    return <svg width="512" height="512" viewBox="0 0 512 512" {...props}>
        ...
        <circle cx="406.33" cy="149.45" r="35" className="fill-primary" />
        <path d="M428.446 133.961c8.537 12.193 5.563 29.064-6.631 37.604-12.195 8.539-29.066 5.564-37.605-6.631s-5.564-29.064 6.631-37.604 29.064-5.564 37.605 6.631m10.649-7.457c-12.672-18.096-37.615-22.492-55.709-9.822-18.096 12.67-22.496 37.613-9.824 55.709 12.672 18.098 37.613 22.494 55.709 9.824 18.095-12.672 22.496-37.613 9.824-55.711z" /><circle cx="74.33" cy="224.45" r="35" className="fill-primary" /><path d="M96.446 208.967c8.537 12.193 5.563 29.064-6.631 37.604-12.195 8.539-29.066 5.564-37.605-6.631s-5.564-29.064 6.631-37.604 29.064-5.564 37.605 6.631m10.649-7.457c-12.672-18.096-37.615-22.492-55.709-9.822-18.096 12.67-22.496 37.613-9.824 55.709 12.672 18.097 37.613 22.494 55.709 9.824 18.095-12.672 22.496-37.613 9.824-55.711z" /><circle cx="311" cy="431.45" r="35" className="fill-primary" /><path d="M333.122 415.967c8.537 12.193 5.563 29.064-6.631 37.604-12.195 8.539-29.066 5.564-37.605-6.631s-5.564-29.064 6.631-37.604 29.064-5.565 37.605 6.631m10.649-7.457c-12.672-18.096-37.615-22.492-55.709-9.822-18.096 12.67-22.496 37.613-9.824 55.709 12.672 18.098 37.613 22.494 55.709 9.824 18.095-12.672 22.495-37.614 9.824-55.711z" />
    </svg>
}
...
export function ReCircleIcon(props) {
    ...
    return <svg width="512" height="512" viewBox="0 0 512 512" {...props}>
        <path fill="none" className="stroke-info" opacity=".6" strokeWidth="13" d="M440.11 256c0 101.502-82.429 183.785-184.11 183.785-101.681 0-184.11-82.283-184.11-183.785S154.319 72.215 256 72.215c101.682 0 184.11 82.283 184.11 183.785z" />
        <path className="stroke-content" strokeWidth="13" opacity=".6" d="m 256.36387,52.551227 1.69377,414.810723" />
        <path className="stroke-content" strokeWidth="13" opacity=".6" d="M 464.57321,256.94796 49.762482,258.64173" />
        ...
        <circle className="fill-primary" cx="202.7123" cy="184.80946" r="35" />
...
export function ReCircleIconAd(props) {
    ...
    return <svg width="512" height="512" viewBox="0 0 512 512" className={cn('-scale-x-100', className)}  {...rest}>
        <path fill="none" className="stroke-secondary" opacity=".6" strokeWidth="13" d="M440.11 256c0 101.502-82.429 183.785-184.11 183.785-101.681 0-184.11-82.283-184.11-183.785S154.319 72.215 256 72.215c101.682 0 184.11 82.283 184.11 183.785z" />
        <path className="stroke-content" strokeWidth="13" opacity=".6" d="m 256.36387,52.551227 1.69377,414.810723" />
        <path className="stroke-content" strokeWidth="13" opacity=".6" d="M 464.57321,256.94796 49.762482,258.64173" />
        <path fill="none" strokeWidth="18" d="m 439.6681,253.84568 c 0,69.28806 -58.81453,125.45669 -131.3657,125.45669 -72.55118,0 -131.3657,-56.16863 -131.3657,-125.45669 0,-69.28805 58.81452,-125.45669 131.3657,-125.45669 72.55189,0 131.3657,56.16864 131.3657,125.45669 z" />
        <circle className="fill-primary" cx="202.7123" cy="184.80946" r="35" />
...
export function ImCircleIcon(props) {
    ...
    return <svg width="512" height="512" viewBox="0 0 512 512" {...props}>
        ...
        <circle cx="196.77518" cy="157.2728" r="35" className="fill-primary" />
