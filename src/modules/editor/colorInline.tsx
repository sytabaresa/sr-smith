...
export const ColorInlineLeaf = (props) => {
    ...
    return <span className="inline-color-wrapper">
        <span className="inline-block border border-secondary p-px mr-1 w-3 h-3 bg-clip-content"
...
export function colorInline(grammar) {
    ...
    prism.languages.DFS(grammar, function (key, def, type) {
        if (candidates.indexOf(type) > -1 && !Array.isArray(def)) {
            ...
            def.inside['color'] = color
            def.inside['hexcode'] = hexcode;
        }
    });
